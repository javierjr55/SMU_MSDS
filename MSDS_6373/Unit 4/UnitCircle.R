...
mtext("imaginary", side = 2, line = -12.2, at = 1.4)
mtext("real", side = 3, line = -12.5, at = 1.4)
...
mtext("Length", side = 3, at = c(-1.8), line = 1.5)
mtext("Abs Reciprocal", side = 3, at = c(1.5), line = 1.5)

#Display distance from origin and Abs Reciprocal Values
mtext(as.character(round(length,4)), side = 3, at = c(-1.8), line = .5)
mtext(as.character(round(1/abs(length),4)), side = 3, at = c(1.5), line = .5)
